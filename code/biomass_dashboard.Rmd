...
domain_biomass_map <- left_join(neon_domains_w_points, domain_biomass_summary, by = "domain_id") %>%
  mutate(
    text_label = str_c("<b>", domain_id, ": ",
                       domain_name,  "</b>",
                       "</br>Mean Biomass/Hour: ", round(mean_bm, digits = 4), "mg",
                       "</br>Biomass/Hour S.D: ", round(sd_bm, digits = 4), "mg",
                       "</br># of Trap Events: ", n)
  )
...
domain_biomass_phenology <- sort_data %>% 
  ...
  mutate(
    text_label = str_c(domain_id, ": ", domain_name,
                       "\nMean Biomass/Hour: ", round(mean_bm, digits = 4), "mg",
                       "\nBiomass/Hour S.D: ", round(sd_bm, digits = 4), "mg",
                       "\n# of Trap Events: ", n)
  )
